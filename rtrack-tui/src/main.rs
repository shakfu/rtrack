...
fn run_render(
    ...
    let title = &app.core.song.title;
    let bpm = app.core.song.bpm;
    ...
    let sample_rate = app.core.export_sample_rate();
    let channel_fx = app.core.channel_effects_params_slice();
...
fn run_headless(
    ...
    loop {
        ...
        if loops > 0 && app.core.engine.generation >= loops {
            break;
        }
...
fn run_app(
    ...
    loop {
        ...
        let timeout = if app.core.is_playing() {
