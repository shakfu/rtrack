...
impl Theme {
    pub fn dark() -> Self {
        Self {
            ...
            note_empty: Color::Rgb(80, 80, 95),
            instrument_set: Color::Yellow,
            instrument_empty: Color::Rgb(80, 80, 95),
            volume_set: Color::Green,
            volume_empty: Color::Rgb(80, 80, 95),
            effect_set: Color::Cyan,
            effect_empty: Color::Rgb(80, 80, 95),
            muted_dim: Color::Rgb(65, 65, 75),
    ...
    pub fn monokai() -> Self {
        Self {
            ...
            note_empty: Color::Rgb(90, 88, 78),
            instrument_set: Color::Rgb(230, 219, 116),
            instrument_empty: Color::Rgb(90, 88, 78),
            volume_set: Color::Rgb(166, 226, 46),
            volume_empty: Color::Rgb(90, 88, 78),
            effect_set: Color::Rgb(102, 217, 239),
            effect_empty: Color::Rgb(90, 88, 78),
            muted_dim: Color::Rgb(72, 70, 62),
